<footer class="pb-0 bg-very-light-gray cover-background background-position-center-top sm-background-image-none" style="background-image: url('{{ asset('assets/restaurant/images/demo-restaurant-home-footer-bg.jpg') }}');
">
    <div class="container">
                ...
                <div class="feature-box ps-8 pe-8 lg-ps-0 lg-pe-0 overflow-hidden">
                    ...
                    <div class="feature-box-content last-paragraph-no-margin">
                        ...
                        <div class="w-100 d-block">
                            <span class="d-block">Phone: <a href="tel:1800222000">+92 319 5199686</a></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                {{-- <div class="col-md-4 col-sm-6 fs-15 last-paragraph-no-margin text-center text-sm-start order-3 order-sm-2 order-md-1"> 
                    <p>&COPY; Copyright 2024   <a href="index.html" target="_blank" class="text-decoration-line-bottom text-dark-gray fw-600">Crafto</a></p>
                </div> --}}
                <div class="col-md-4 text-center order-1 order-md-2 sm-mb-20px"> 
                    <a href="demo-restaurant.html" class="footer-logo d-inline-block"> 
                        <img src="{{ asset('assets/restaurant/images/restaurant-logo.png') }}" data-at2x="{{ asset('assets/restaurant/images/restaurant-logo.png') }}" alt="" class="default-logo">
                    </a>
                </div>
                <div class="col-md-4 col-sm-6 elements-social social-icon-style-08 xs-mb-15px text-center text-sm-end order-2 order-sm-3 order-md-3">
                    <ul class="small-icon dark d-inline-block">
                        <li><a class="facebook" href="https://www.facebook.com/p/Ovee-Labs-100082879345140/?_rdr" target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
                        <li><a class="dribbble" href="https://www.linkedin.com/company/oveelabs" target="_blank"><i class="fa-brands fa-linkedin"></i></a></li>
